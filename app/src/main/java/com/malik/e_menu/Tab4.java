...
public class Tab4 extends Fragment {
    ...
    class myAsynTask extends AsyncTask<Object,Object,Object>{
        ...
        protected Object doInBackground(Object... objects) {
            String url = "http://"+UserSelection.urlget+"/resturent_servicetest.php?act=Data_Selection&Request_category=bevereges";
            Log.i("urls",url);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Tab4.myAsynTask(context,listView).execute();
