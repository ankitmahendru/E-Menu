...
import static com.malik.e_menu.R.id.progressBar;
...
public class ArticlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FEED_URL = "https://newsapi.org/v1/articles?source="+id+"&apiKey=58444f2296514ccd9893956978e7a10b";
...
public class AsyncHttpTask extends AsyncTask<String, Void, String> {
    ...
    public void onBackPressed() {
        startActivity(new Intent(ArticlesActivity.this,UserHome.class));
    }
}
