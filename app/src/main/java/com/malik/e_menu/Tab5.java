...
public class Tab5 extends Fragment {
    ...
    class myAsynTask extends AsyncTask<Object,Object,Object>{
        ...
        protected Object doInBackground(Object... objects) {
            ...
            String url = "http://"+UserSelection.urlget+"/resturent_servicetest.php?act=Data_Selection&Request_category=desert";
            Log.i("urls",url);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView = (ListView) v.findViewById(R.id.list5);

        new Tab5.myAsynTask(context,listView).execute();
        return v;
